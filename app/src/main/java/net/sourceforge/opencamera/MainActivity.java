...
public class MainActivity extends Activity  implements View.OnDragListener, View.OnLongClickListener{
    ...
    protected void onCreate(Bundle savedInstanceState) {
        sp = getSharedPreferences("lastFunction", Activity.MODE_PRIVATE);
    ...
    public void cpFunction(View view) {
    ...
    public void clickedTakePhoto(View view) {
        ...
        Toast myToast = Toast.makeText(this.getApplicationContext(),"[clickedTakePhoto] copied!", Toast.LENGTH_SHORT);
        myToast.show();
